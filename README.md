...
one point for each clean square over a lifetime of 1000 steps.

Environment: two squares, dirt distribution unknown, assume actions are deterministic and
the environment is static (clean squares stay clean).

Actuators: Left, Right, Suck, NoOp.

Sensors: The agent can perceive its location and whether the location is dirty.</p>
...
To customize it, provide as a table a dictionary of all
